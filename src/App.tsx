...
const QUESTIONS: Question[] = [
  { 
    id: 'Q1', category: 'User Research', text: 'وقتی میخواهید محصول جدیدی بیاورید، دکور را تغییر دهید یا روش ارائه خدمات را عوض کنید، چطور مطمئن میشوید مشتریان واقعاً از آن استقبال میکنند؟',
    options: [
  ...
  { 
    id: 'Q2', category: 'Customer Journey', text: 'فرآیند آشنایی مشتری با شما، ثبت سفارش و تحویل نهایی چقدر برای او روان و بیدردسر پیش میرود؟',
    options: [
      { value: 'A', label: 'به دلیل ماهیت کار ما، فرآیند خرید به هماهنگیهای دستی زیادی نیاز دارد؛ مشتریان سوالات مکرری میپرسند و بخش زیادی از کار را به صورت تلفنی یا حضوری جلو میبریم.', points: 0 },
      ...
      { value: 'C', label: 'مسیر خرید نسبتاً روان است، اما تجربه مشتری در بخشهای مختلف (مثلاً نحوه برخورد در سایت با تماس تلفنی یا تحویل حضوری) هنوز کاملاً یکدست نیست.', points: 2 },
      { value: 'D', label: 'تمام مراحل خرید و تحویل به هم متصل و شفاف هستند؛ مشتری بدون نیاز به پیگیری یا تماس اضافه، به راحتی به خواستهاش میرسد.', points: 3 },
    ]
  },
  { 
    id: 'Q3', category: 'Value Proposition', text: 'مشتریان چقدر راحت متوجه میشوند که چرا باید شما را انتخاب کنند، نه رقبایتان را؟',
    options: [
      { value: 'A', label: 'در این بازار پر از رقابت، تفاوت عجیبی بین ما و بقیه نیست؛ به همین دلیل معمولاً مجبوریم با کاهش قیمت یا تخفیفهای مداوم مشتری را جذب کنیم.', points: 0 },
      { value: 'B', label: 'کارمان واقعاً باکیفیت است، اما شلوغی کار فرصت نداده این تمایز را به زبان ساده در وبسایت یا توسط تیم فروش به مشتری توضیح دهیم.', points: 1 },
      { value: 'C', label: 'تفاوتهای خوبی داریم و مشتریان قدیمی این را میدانند، اما گاهی مشتریان جدید بعد از خرید حس میکنند محصول با ادعای اولیه ما کمی تفاوت دارد.', points: 2 },
  ...
  { 
    ...
    options: [
      { value: 'A', label: 'حجم کارها بالاست و اطلاعات زیادی بین بچهها جابهجا میشود؛ به همین دلیل گاهی هماهنگیها از دستمان در میرود و کار مشتری با تاخیر یا اشتباهات ناخواسته مواجه میشود.', points: 0 },
      { value: 'B', label: 'روال کار در ذهن افراد کلیدی هست، اما چون مکتوب نشده، در روزهای شلوغ یا زمان غیبت یک نفر، فشار کار روی بقیه چند برابر شده و سرعت کار کم میشود.', points: 1 },
      { value: 'C', label: 'فرآیندها و روالهای اداری مشخصی داریم، اما بعضی از آنها دستوپاگیر هستند و به جای سرعت دادن به کار مشتری، فرآیند را طولانی میکنند.', points: 2 },
      { value: 'D', label: 'هماهنگی داخلی ما عالی است؛ فرآیندهای پشت صحنه به گونهای چیده شدهاند که کار مشتری دقیق، بدون خطا و سر وقت انجام شود.', points: 3 },
    ]
  },
  { 
    id: 'Q5', category: 'Employee Experience', text: 'کارمندانی که مستقیماً با مشتری سر و کار دارند (پشتیبانی، فروشنده و...) چقدر ابزار و اختیار برای حل سریع چالشهای مشتری دارند?',
    options: [
      { value: 'A', label: 'برای حفظ کیفیت و جلوگیری از خطا، ترجیح میدهیم تصمیمات و تخفیفهای کلیدی حتماً با تایید مستقیم مدیریت انجام شود؛ حتی اگر پاسخ به مشتری کمی طولانی شود.', points: 0 },
      { value: 'B', label: 'روال کار را میدانند، اما به دلیل یکپارچه نبودن سیستمها یا نرمافزارها، برای چک کردن سوابق مشتری یا حل مشکل او زمان زیادی صرف میکنند.', points: 1 },
      { value: 'C', label: 'دسترسی و ابزارها خوب است، اما روال یا استاندارد مشخصی برای نحوه برخورد با مشتریان شاکی یا شرایط خاص تعریف نکردهایم.', points: 2 },
      { value: 'D', label: 'ابزارها و اختیارات لازم را دارند تا در سریعترین زمان ممکن، مشکل مشتری را در همان خط اول حل و او را با رضایت راهی کنند.', points: 3 },
    ]
  },
  { 
    id: 'Q6', category: 'Feedback Loop', text: 'وقتی مشتری از کار یا محصول شما انتقاد میکند یا شاکی است، فرآیند چطور پیش میرود؟',
    options: [
      { value: 'A', label: 'راه یا کانال مشخصی برای شنیدن صدای مشتری ناراضی نداریم؛ فرآیند معمولاً با پیگیریهای خستهکننده برای مشتری همراه است.', points: 0 },
      { value: 'B', label: 'تمام تلاشمان را میکنیم تا با عذرخواهی یا تخفیف، رضایت آن مشتری شاکی را جلب کنیم، اما به دلیل کمبود وقت، تغییری در روش کارمان ایجاد نمیکنیم.', points: 1 },
      ...
      { value: 'D', label: 'شکایتها را بهترین فرصت برای بهبود میدانیم؛ به سرعت آنها را تحلیل کرده و روش ارائه خدماتمان را اصلاح میکنیم.', points: 3 },
    ]
  },
  { 
    id: 'Q7', category: 'Prototyping & Testing', text: 'وقتی ایده جدیدی برای کارتان دارید (مثلاً یک روش جدید فروش، تغییر چیدمان یا یک خدمت جدید)، چطور آن را شروع میکنید؟',
    options: [
      { value: 'A', label: 'مستقیم روی کل کار پیاده میکنیم و هزینه زیادی میدهیم؛ ترجیح میدهیم زودتر خروجی واقعی کار را در ابعاد بزرگ ببینیم.', points: 0 },
      { value: 'B', label: 'ایده را در جلسات با مدیران بررسی میکنیم و اگر خودمان بپسندند، آن را بدون ریسک گرفتن از نظر مشتریان، در کل کار اجرا میکنیم.', points: 1 },
  ...
  { 
    id: 'Q8', category: 'UX Metrics', text: 'اگر سایت یا فرآیند فروش آنلاین دارید، چطور متوجه میشوید مشتریان کجاها گیر میکنند یا خرید را نیمهکاره رها میکنند؟',
    options: [
      ...
      { value: 'C', label: 'میدانیم مشتریان در کدام مرحله (مثلاً صفحه پرداخت یا پر کردن مشخصات) خارج میشوند، اما دلیل رفتاری و علت آن را بررسی نکردهایم.', points: 2 },
  ...
  { 
    ...
    options: [
      { value: 'A', label: 'فرآیندها کشش ندارند؛ سیستم دچار تاخیر شدید شده و ناخواسته افت کیفیت کیفیت خدمات باعث نارضایتی مشتریان میشود.', points: 0 },
      { value: 'B', label: 'با کارایی فرسایشی، اضافهکاری و استرس شدید تیم پاسخگو خواهیم بود، اما کیفیت کار برای همه مشتریان یکسان نخواهد بود.', points: 1 },
  ...
  { 
    ...
    options: [
      { value: 'A', label: 'تغییر در کار ما زمانبر و پرهزینه است؛ هر تغییر کوچک در روال کار ما ماهها زمان میبرد و با مقاومت فنی یا داخلی مواجه میشود.', points: 0 },
