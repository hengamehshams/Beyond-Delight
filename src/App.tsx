...
در Beyond، ما باور داریم حل مسئله قبل از طراحی راه‌حل شروع می‌شود. بسیاری از مشکلاتی که در ظاهر ساده به نظر می‌رسند، ریشه در تعامل میان فرایندها، افراد، ساختار و تصمیم‌های سازمان دارند. بنابراین قبل از اینکه به سراغ راه‌حل برویم، باید مسئله را درست ببینیم، درباره آن سؤال بپرسیم و ریشه‌هایش را بهتر بشناسیم.

این پرسشنامه با الهام از چارچوب 7S مکنزی طراحی شده تا نقطه شروعی برای همین فرایند باشد؛ فرصتی برای شناخت وضعیت فعلی، کشف ناهماهنگی‌ها و پیدا کردن مسائلی که ارزش بررسی و طراحی دارند.            </p>
